...
parser.add_argument("--config", type=str, default=os.path.join(sd_path, "configs/stable-diffusion/anime-inference.yaml"), help="path to config which constructs model",)
